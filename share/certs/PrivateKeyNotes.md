...
unlocked to sign the UnattainiumV2-Qt.app bundle.
...
allowing somebody to distribute a UnattainiumV2-Qt.app or unattainiumv2-qt-setup.exe with a valid
...
that the unattainiumv2-qt.exe file inside the installer had not been tampered with.
