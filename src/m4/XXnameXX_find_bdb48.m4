AC_DEFUN([UNATTAINIUMV2_FIND_BDB48],[
  ...
  if test "x$bdbpath" = "xX"; then
    ...
    UNATTAINIUMV2_SUBDIR_TO_INCLUDE(BDB_CPPFLAGS,[${bdbpath}],db_cxx)
    ...
    UNATTAINIUMV2_SUBDIR_TO_INCLUDE(BDB_CPPFLAGS,[${bdb48path}],db_cxx)
    bdbpath="${bdb48path}"
  fi
